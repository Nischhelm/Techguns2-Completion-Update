...
public class ModelAlienBug extends ModelBase {
     ...
     */
    public void setRotationAngles(float p1, float p2, float p3, float p4, float p5, float p6, @NotNull Entity entity) {
        //HEAD
        ...
        this.L1_A.rotateAngleX -= f9;
        this.L1_A_3.rotateAngleX += f9;
        this.L1_A_2.rotateAngleX -= f10;
        this.L1_A_1.rotateAngleX += f10;
        ...
        if (entity instanceof AlienBug) {
            ...
            if (a > 5 && a <= 10) {
                ...
                double v = 0.5 * (1 - Math.cos(f * Math.PI));
                this.JAW_U.rotateAngleX += v * 0.3F;
                this.JAW_L.rotateAngleX -= v * 0.4F;
            }
        }
