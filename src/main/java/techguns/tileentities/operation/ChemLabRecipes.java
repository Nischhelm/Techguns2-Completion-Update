...
public class ChemLabRecipes {
    ...
    public static boolean isItemValidForSlot1(ItemStack item) {
        for (ChemLabRecipe recipe : recipes) {
            if (!recipe.slot1.isEmpty() && recipe.slot1.isEqualWithOreDict(item)) {
                return true;
            }
        }
        return false;
    ...
    public static boolean isItemValidForSlot2(ItemStack item) {
        for (ChemLabRecipe recipe : recipes) {
            if (!recipe.slot2.isEmpty() && recipe.slot2.isEqualWithOreDict(item)) {
                return true;
            }
        }
        return false;
    ...
    public static boolean isRecipeMatch(ItemStack slot1, ItemStack slot2) {
        for (ChemLabRecipe recipe : recipes) {
            if (recipe.slot1.isEqualWithOreDict(slot1) && recipe.slot2.isEqualWithOreDict(slot2)) {
                return true;
            }
        }
        return false;
