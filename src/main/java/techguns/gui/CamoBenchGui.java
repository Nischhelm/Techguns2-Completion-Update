...
public class CamoBenchGui extends OwnedTileEntGui {
    ...
    public static final ResourceLocation texture = new ResourceLocation(Tags.MOD_ID, "textures/gui/camo_bench_gui.png");// new
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (!item.isEmpty()) {
            if (item.getItem() instanceof ICamoChangeable camoitem) {
    ...
    private int getArmorCamo(int slot) {
        ...
        if (!armor.isEmpty() && armor.getItem() instanceof ICamoChangeable camoArmor) {
