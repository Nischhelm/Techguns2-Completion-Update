...
public class GuiButtonSecurity extends GuiButtonExt {
    ...
    public static final ResourceLocation texture_security = new ResourceLocation(Tags.MOD_ID, "textures/gui/ammo_press_gui.png");//new ResourceLocation("textures/gui/container/ammopressgui.png");
