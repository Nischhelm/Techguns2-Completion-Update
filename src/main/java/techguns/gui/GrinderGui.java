...
public class GrinderGui extends PoweredTileEntGui {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.drawSaw(k + 62, l + 15, 198, angleUpper);
        this.drawSaw(k + 62, l + 44, 227, angleLower);
    }

    private void drawSaw(int x, int y, int v, float angle) {
        ...
        this.drawTexturedModalRect(0, 0, 227, v, 29, 29);
