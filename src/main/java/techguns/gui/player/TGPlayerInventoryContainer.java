...
public class TGPlayerInventoryContainer extends Container {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int id) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            //Try merge Armor
            else if (itemstack.getItem() instanceof ItemArmor && !this.inventorySlots.get(TGPlayerInventory.NUMSLOTS + ((ItemArmor) itemstack.getItem()).armorType.getIndex()).getHasStack()) {
